...
class InterventionType < SourceAdapter
  def initialize(source,credential)
     @base = 'http://localhost:3001/intervention_types'
  ...
  def xmetadata
    ...
    objectlink = { :type => "linkli", :uri => "/app/Intervention/edit/{{object}}", :text => "Interventionss : {{object}}|{{intervention_type.name_fr}}" }
